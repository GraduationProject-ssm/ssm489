...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1t58veLEnL?p=87)
...
### 3.1.1操作可行性分析
开发本系统需要用到的工具，本人都比较熟悉，因此可以使用这些工具，完整开发高校勤工助学系统。此外，高校勤工助学系统在功能上，基本都是完成信息的处理，涵盖了添加，修改，删除等，而且操作者面对的都是各个功能操作界面，并不是编码后台，所以一般的使用者都可以通过操作界面轻松完成信息的加工处理。因此，本系统操作可行。
### 3.1.2经济可行性分析
...
### 3.1.3技术可行性分析
本系统需要的软件包括Eclipse，Tomcat，Mysql等，这些工具都接触并使用过，至于JAVA，B/S，vue，Html等技术，图书馆都有对应的书籍可以参考学习，加上平时课堂上学习的编程小项目对这些技术都有讲解，另外，本人也从课程设计作业中锻炼了编程能力。所以在技术上，可以完成高校勤工助学系统的编程开发。

通过上面的分析，已经确定了本系统在经济上的可行，本系统在技术上的可行，本系统在操作上的可行。由此，可以得出在目前的条件下，对于高校勤工助学系统的设计与实现是可以进行下去的。
## 3.2系统流程分析
...
图3.3 查询信息流程图
## 3.3系统性能分析
分析高校勤工助学系统对于性能的需求主要还是从下面的5个角度来分析，它们分别是系统的实用性，系统的适应性，系统的易操作性，系统的安全性和系统的易维护性。
...
![C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\用户.jpg](/md/blog.005.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\用户.jpg")
图4.1 用户实体属性图

（2）下图是职位留言实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\职位留言.jpg](/md/blog.006.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\职位留言.jpg")
图4.2 职位留言实体属性图

（3）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\公告信息.jpg](/md/blog.007.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\公告信息.jpg")
图4.3 公告信息实体属性图

（4）下图是贫困生申请实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\贫困生申请.jpg](/md/blog.008.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\贫困生申请.jpg")
图4.4 贫困生申请实体属性图

（5）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\字典表.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\字典表.jpg")
图4.5 字典表实体属性图

（6）下图是公司实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\公司.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\公司.jpg")
图4.6 公司实体属性图

（7）下图是简历实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\简历.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\简历.jpg")
图4.7 简历实体属性图

（8）下图是简历投递实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\简历投递.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\简历投递.jpg")
图4.8 简历投递实体属性图

（9）下图是职位收藏实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\职位收藏.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\职位收藏.jpg")
图4.9 职位收藏实体属性图

（10）下图是职位招聘实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\职位招聘.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\职位招聘.jpg")
图4.10 职位招聘实体属性图

（11）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\用户表.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoqingongzuxue\用户表.jpg")
图4.11 用户表实体属性图
...
|11|jianli\_phone|String|手机号|是|
|12|jianli\_photo|String|照片|是|
|13|jianli\_address|String|位置|是|
|14|jiaoyu\_text|String|教育经历|是|
|15|shixi\_text|String|实习或工作经历|是|
|16|geren\_text|String|个人介绍|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|pinkuensjhengshenqing\_name|String|标题|是|
|3|pinkuensjhengshenqing\_file|String|证明文件|是|
|4|insert\_time|Date|申请时间|是|
|5|yonghu\_id|Integer|申请学生|是|
|6|pinkuensjhengshenqing\_yesno\_types|Integer|申请结果|是|
|7|pinkuensjhengshenqing\_yesno\_text|String|原因|是|
|8|news\_delete|Integer|假删|是|
|9|create\_time|Date|创建时间|是|
表4.6简历投递表
...
|9|zhaopin\_file|String|申请表|是|
|10|zan\_number|Integer|赞|是|
|11|cai\_number|Integer|踩|是|
|12|zhaopin\_types|Integer|招聘岗位|是|
...
功能模块的实现
### 5.1用户信息管理
如图5.1显示的就是用户信息管理页面，查看自己的个人信息并修改还可以查看自己收藏的招聘职位信息并进行条件筛选和删除

![](/md/blog.016.png)

图5.1 用户信息管理页面
### 5.2 公司信息管理
如图5.2显示的就是公司信息管理页面，不登录可查看list页面的数据并可以通过公司名称进行模糊查询进行筛选，登录后可进入详情页面看到公司的全部信息
...
图5.2 公司信息管理页面
### 5.3简历信息管理
如图5.3显示的就是简历信息管理页面，不登录可查看list页面的数据并可以通过简历名称进行模糊查询进行筛选和简历类型、学历、期望工资进行条件查询，登录后可进入详情页面看到简历的全部信息
...
图5.3 简历信息管理页面
### 5.1公告信息管理
如图5.4显示的就是公告信息管理页面，不登录可查看list页面的数据并可以通过公告名称进行模糊查询进行筛选和公告类型进行条件查询，登录后可进入详情页面看到公告的全部信息。
